                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        isEnabled ? 'save' : 'edit',
                        style:
                            TextStyle(fontSize: 16, color: xColors.white),
                      ),
                    ],
                  ),
                ),
  ...
  void _apiRequest() async {
    ...
    if (name == null || name.isEmpty) {
      ...
      DoctorModel newModel = DoctorModel(
          ...
          subCity: subCity,
          city: city);
      await DatabaseService().updateDoctor(updatedDoctor: newModel,image: pickedImage ,passChanged : widget.user.password !=password);
    }
  }
